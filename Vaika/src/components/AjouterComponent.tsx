...
const AjouterC: React.FC<{ data: Marque[] }> = ({ data }) => {
  ...
  const AddMarque = async () => {
    ...
    const url = 'http://localhost:8080/api/v1/marques'; // Replace with your actual API endpoint
  ...
  return (
    <IonContent>
      <IonCard>
        ...
        <IonCardContent>
          <h5>Listes des marques existant :</h5>
                  ...
                  <td style={{width: '25%'}} >
                    <div className="btn-group dropend">
                      ...
                      <ul className="dropdown-menu">
                        <li>
                          <a className="dropdown-item" href={`/Modification/Marques/${obj.id_marque}`}>
                            Modifier
                          </a>
                        </li>
                        <li>
